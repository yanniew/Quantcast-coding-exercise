...
Test 2: Use 2018-12-07 as the date to test if there is only one active cookie
    Should print out 4sMM2LxV07bPJzwf

Test 3: Use 2018-12-09 as the date to test if there are multiple active cookies and a single most active cookie
    Should print out AtY0laUfhglK3lC7

Test 4: Use 2018-12-08 as the date to test if there are multiple most active cookies
